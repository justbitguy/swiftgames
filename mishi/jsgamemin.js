		...
		canvas: function() {
			...
			return {
				...
				drawRegion: function(n, r, i, s, o, u, a, f) {
					switch (u) {
						default: t.setTransform(1, 0, 0, 1, a, f);
						break;
				...
				drawNumber: function(t, n, r, i, s, o, u, a, f) {
					...
					f = f ? f : i;
					if (u)
						for (u = 0; u < l; u++) e.drawImage(n, parseInt(t.charAt(u)) * r, 0, r, i, s + u * a, o, a, f);
					else
						for (u = l - 1; u >= 0; u--) e.drawImage(n, parseInt(t.charAt(u)) * r, 0, r, i, s - (l - 1 - u) * a, o, a, f, jsGame.graphics.ANCHOR_RT);
					return e
				},
				moveTo: function(n, r) {
					t.moveTo(n, r);
