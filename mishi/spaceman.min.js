function main() {
	...
	jsGame.pageLoad(function(t) {
		...
		function o(e) {
			if (D == L) {
				u.isPressed && r(u, e.x, e.y) ? (D = A, P = "CHS", t.localStorage.setItem("language2", P), u.isPressed = !1) : a.isPressed && r(a, e.x, e.y) && (D = A, P = "en", t.localStorage.setItem("language2", P), a.isPressed = !1);
			}
			else {
				if (D == A){
					f.isPressed && r(f, e.x, e.y) ? (D = O, f.isPressed = !1) : l.isPressed && r(l, e.x, e.y) && (/*goHome(), */l.isPressed = !1);
				}
				else {
					D == _ && (c.isPressed && r(c, e.x, e.y) ? (B(), D = M, c.isPressed = !1) : h.isPressed && r(h, e.x, e.y) && (/*D = A, */h.isPressed = !1));
				} 
			}
		}
		e.showClue = function() {
		...
		t.run(function() {
			...
			a.draw("english", 0, a.isPressed ? 1 : 0, a.w, a.h, a.x, a.y, a.w, a.h);
				...
				if ("en" == P) {
					var n = t.canvas.screen.getWidth() / t.getImage("fmE").width;
					t.canvas.drawImage("fmE", 0, 0, t.getImage("fmE").width, t.getImage("fmE").height, 0, 0, t.getImage("fmE").width * n, t.getImage("fmE").height * n);
				}
				else {
				...
				"en" == P ? (f.draw("startE", 0, f.isPressed ? 1 : 0, f.w, f.h, f.x, f.y, f.w, f.h)/*, l.draw("moreE", 0, l.isPressed ? 1 : 0, l.w, l.h, l.x, l.y, l.w, l.h)*/) : (f.draw("start", 0, f.isPressed ? 1 : 0, f.w, f.h, f.x, f.y, f.w, f.h)/*, l.draw("more", 0, l.isPressed ? 1 : 0, l.w, l.h, l.x, l.y, l.w, l.h)*/)
			} else if (D == O) {
				j(),
				"en" == P ? (t.canvas.drawImage("introE", (t.canvas.screen.getWidth() - t.getImage("introE").width) / 2, 60)): t.canvas.drawImage("intro", (t.canvas.screen.getWidth() - t.getImage("intro").width) / 2, 60);
			}
			else if (D == _) {
				j();
				...
				k = 0 == rt ? k + 1 : k - 1;
				var r = t.getImage(GameLang == "en" ? "sbE" : "sb"),
				n = r.width,
				r = r.height,
				n = parseInt((t.canvas.screen.getWidth() - n) / 2),
				r = parseInt((t.canvas.screen.getHeight() - r) / 2) - 40;
				t.canvas.drawImage(GameLang == "en" ? "sbE" : "sb", n, r);
				"en" == P ? (t.canvas.drawImage("scoreE", n + 52, r + 200).drawNumber(v.mission, "sz", 8, 15, n + 110, r + 202, !1), t.canvas.drawImage("HscoreE", n + 50, r + 170).drawNumber(H, "sz", 8, 15, n + 144, r + 172, !1), c.draw("retryE", 0, c.isPressed ? 1 : 0, c.w, c.h, c.x, c.y, c.w, c.h)/*, h.draw("backE", 0, h.isPressed ? 1 : 0, h.w, h.h, h.x, h.y, h.w, h.h)*/) : (t.canvas.drawImage("score", n + 52, r + 200).drawNumber(v.mission, "sz", 8, 15, n + 112, r + 202, !1), t.canvas.drawImage("Hscore", n + 50, r + 170).drawNumber(H, "sz", 8, 15, n + 140, r + 172, !1), c.draw("retry", 0, c.isPressed ? 1 : 0, c.w, c.h, c.x, c.y, c.w, c.h)/*, h.draw("back", 0, h.isPressed ? 1 : 0, h.w, h.h, h.x, h.y, h.w, h.h)*/)
			} else if (4 == D)"en" == P ? t.canvas.drawImage("isexitE", (t.canvas.screen.getWidth() - t.getImage("isexit").width) / 2, 300) : t.canvas.drawImage("isexit", (t.canvas.screen.getWidth() - t.getImage("isexit").width) / 2, 300);
			...
			case 1:
				...
				"en" == P ? (t.canvas.fillStyle("#000000").fillRect(0, 624, t.canvas.screen.getWidth(), 2).drawImage("scoreE", 382, 5).drawNumber(v.mission, "sz", 8, 15, 435, 5, !1), t.canvas.drawImage("HscoreE", 2, 5).drawNumber(H, "sz", 8, 15, 120, 5, !1)) : (t.canvas.fillStyle("#000000").fillRect(0, 624, t.canvas.screen.getWidth(), 2).drawImage("score", 382, 5).drawNumber(v.mission, "sz", 8, 15, 435, 5, !1), t.canvas.drawImage("Hscore", 2, 5).drawNumber(H, "sz", 8, 15, 120, 5, !1));
